...
import com.scu.restaurantfinder.model.SignUpRequest;
...
public class UserController {
    ...
    public ResponseEntity<String> createAdminUser(@RequestBody User adminUser) {
        try {
            logger.info("Creating admin user: {}", adminUser.getEmail());
